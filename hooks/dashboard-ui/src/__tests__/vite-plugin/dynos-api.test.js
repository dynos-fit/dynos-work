...
function createMockReq(url, method = "GET", body) {
    const handlers = {};
    const req = {
        url,
        method,
...
function setupTaskDirectories(projectPath, taskIds) {
...
describe("GET /api/tasks/:taskId/retrospective", () => {
    it("returns the task-retrospective.json for a valid task", () => {
        ...
        const data = JSON.parse(fs.readFileSync(`${PROJECT_PATH}/.dynos/task-20260406-001/task-retrospective.json`));
    ...
    it("returns 404 when retrospective file is missing", () => {
        ...
        expect(() => {
            fs.readFileSync(`${PROJECT_PATH}/.dynos/task-20260406-001/task-retrospective.json`);
        }).toThrow("ENOENT");
...
describe("GET /api/tasks/:taskId/execution-log", () => {
    it("returns parsed lines from execution-log.md", () => {
        ...
        const raw = fs.readFileSync(`${PROJECT_PATH}/.dynos/task-20260406-001/execution-log.md`);
...
describe("GET /api/agents", () => {
    it("returns agents array from learned-agents/registry.json", () => {
        ...
        const data = JSON.parse(fs.readFileSync(`${PERSISTENT_DIR}/learned-agents/registry.json`));
...
describe("GET /api/findings", () => {
    it("returns findings array from proactive-findings.json", () => {
        ...
        const data = JSON.parse(fs.readFileSync(`${PROJECT_PATH}/.dynos/proactive-findings.json`));
...
describe("GET /api/autofix-metrics", () => {
    it("returns metrics object with totals", () => {
        ...
        const data = JSON.parse(fs.readFileSync(`${PERSISTENT_DIR}/autofix-metrics.json`));
...
describe("GET /api/policy", () => {
    it("returns policy config from persistent directory", () => {
        ...
        const data = JSON.parse(fs.readFileSync(`${PERSISTENT_DIR}/policy.json`));
...
describe("GET /api/registry", () => {
    it("returns the global registry with projects array", () => {
        setupFilesystem({ [REGISTRY_PATH]: sampleRegistry });
        const data = JSON.parse(fs.readFileSync(REGISTRY_PATH));
...
describe("GET /api/retrospectives", () => {
    it("returns all retrospective objects augmented with task_id", () => {
        ...
        const retro = JSON.parse(fs.readFileSync(`${PROJECT_PATH}/.dynos/task-20260406-001/task-retrospective.json`));
