...
1. Determine the plugin's hooks directory using the configured hooks path (${CLAUDE_PLUGIN_ROOT}/hooks), falling back to the `hooks/` directory relative to this skill file if unavailable.
