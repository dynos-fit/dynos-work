...
def test_run_audit_finish_writes_completion_and_transitions_done(tmp_path) -> None:
    ...
    receipt_audit_routing(task_dir, [
        ...
        {"name": "architecture-auditor", "action": "skip", "reason": "fixture", "route_mode": "generic", "agent_path": None},
        {"name": "test-strategy-auditor", "action": "skip", "reason": "fixture", "route_mode": "generic", "agent_path": None},
        {"name": "docs-accuracy-auditor", "action": "skip", "reason": "fixture", "route_mode": "generic", "agent_path": None},
        {"name": "api-contract-auditor", "action": "skip", "reason": "fixture", "route_mode": "generic", "agent_path": None},
        {"name": "observability-auditor", "action": "skip", "reason": "fixture", "route_mode": "generic", "agent_path": None},
