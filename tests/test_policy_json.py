...
class TestModelPolicyJsonGeneration:
    """AC 1: write_patterns() creates model-policy.json with correct schema."""

    def test_model_policy_json_created_on_write_patterns(self, tmp_path: Path, monkeypatch) -> None:
    ...
    def test_model_policy_json_has_entry_for_observed_role_task_type(self, tmp_path: Path, monkeypatch) -> None:
...
class TestSkipPolicyJsonGeneration:
    """AC 2: write_patterns() creates skip-policy.json with correct schema."""

    def test_skip_policy_json_created_on_write_patterns(self, tmp_path: Path, monkeypatch) -> None:
    ...
    def test_skip_policy_excludes_exempt_auditors(self, tmp_path: Path, monkeypatch) -> None:
...
class TestRoutePolicyJsonGeneration:
    """AC 3: write_patterns() creates route-policy.json with correct schema."""

    def test_route_policy_json_created_on_write_patterns(self, tmp_path: Path, monkeypatch) -> None:
...
class TestResolveModelJsonFirst:
    """AC 5: resolve_model() reads model-policy.json first, falls back to markdown."""

    def test_resolve_model_prefers_json_over_markdown(self, tmp_path: Path, monkeypatch) -> None:
    ...
    def test_resolve_model_json_source_is_learned_history(self, tmp_path: Path, monkeypatch) -> None:
    ...
    def test_resolve_model_explicit_policy_overrides_json(self, tmp_path: Path, monkeypatch) -> None:
    ...
    def test_security_floor_overrides_json(self, tmp_path: Path, monkeypatch) -> None:
...
class TestResolveSkipJsonFirst:
    """AC 6: resolve_skip() / _get_skip_threshold() reads skip-policy.json first."""

    def test_skip_threshold_from_json_preferred_over_markdown(self, tmp_path: Path, monkeypatch) -> None:
    ...
    def test_skip_threshold_falls_back_to_markdown_when_no_json_key(self, tmp_path: Path, monkeypatch) -> None:
...
class TestPostmortemWritesToModelPolicyJson:
    """AC 12: apply_improvement() with adjust_model_policy writes to model-policy.json."""

    def test_adjust_model_policy_writes_model_policy_json(self, tmp_path: Path, monkeypatch) -> None:
    ...
    def test_adjust_model_policy_preserves_explicit_policy_entries(self, tmp_path: Path, monkeypatch) -> None:
...
class TestBackwardCompatFallback:
    ...
    def test_resolve_model_returns_default_when_no_json_no_markdown(self, tmp_path: Path, monkeypatch) -> None:
    ...
    def test_skip_threshold_returns_default_when_no_json_no_markdown(self, tmp_path: Path, monkeypatch) -> None:
    ...
    def test_corrupt_json_falls_back_gracefully(self, tmp_path: Path, monkeypatch) -> None:
...
class TestModelOverridesMigration:
    """AC 16: model_overrides migration from policy.json to model-policy.json."""

    def test_model_overrides_migrated_to_model_policy_json(self, tmp_path: Path, monkeypatch) -> None:
    ...
    def test_model_overrides_removed_from_policy_json_after_migration(self, tmp_path: Path, monkeypatch) -> None:
    ...
    def test_migration_preserves_existing_explicit_policy(self, tmp_path: Path, monkeypatch) -> None:
    ...
    def test_migration_is_idempotent(self, tmp_path: Path, monkeypatch) -> None:
